...
import { Database, CheckCircle, AlertCircle, XCircle, Loader } from 'lucide-react';
      ...
      {showDetails && status && (
        <div className="absolute top-full left-0 mt-2 w-96 bg-white border border-gray-200 rounded-lg shadow-lg p-4 text-sm">
          <div className="space-y-3">
            ...
            <div className="border-t pt-3">
              <details>
                <summary className="cursor-pointer font-medium text-blue-600">Setup Instructions</summary>
